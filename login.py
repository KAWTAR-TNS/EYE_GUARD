...
from professor_page import ProfessorPage
...
class LoginApp(App):
    ...
    def build(self):
        ...
        manager.add_widget(PersonPage(name='PersonPage'))
        manager.add_widget(ProfessorPage(name='ProfessorPage'))
        manager.add_widget(StudentPage(name='StudentPage'))
        return manager
